...
class principalsql {
 ...
 private static int opcion=-1;
   ...
   Connection conexion=DriverManager.getConnection(url,"root","Arroyo20@@");  //paso 2 creamos el objeto conexion
   ...
   Connection conexion=DriverManager.getConnection(url,"root","Arroyo20@@"); 
    Statement sentencia= conexion.createStatement();
